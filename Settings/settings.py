...
#import py files
from Settings.changeSalary import *
from Settings.changePassword import *
from Settings.changeQuestion import *
from Settings.changeAnswer import *
...
def delUser(settingsGUI, username):
    ...
    #if user presses yes
    if (MessageBox == 'yes'):
        #double checks if user wants to delete account
...
def settings(screen, offlineMode, username):
    ...
    #if offline mode - restricted access
    if (offlineMode):
    ...
    #if online mode - shows all options
    else:
        #Option Label
